...
export function helpLines() {
  return [
    ...
    "  one cell's worth; at --cell-concurrency 8, up to eight.",
    "",
    "  You do not have to work that out. Every ceiling-gated run prints the bound",
    "  BEFORE it starts, from the concurrency in force and the actual planned",
    "  cells:",
    "",
    "    [max-spend] worst-case stop=$224.9400 (ceiling $220.0000 + up to 8",
    "                in-flight cell(s) at --cell-concurrency 8, worth $4.9400)",
    "",
    "  Size against THAT number, not against the ceiling.",
    "",
    "BALANCE",
    "",
