 ...
 *   hasMissingRate: boolean, missingRateModels: string[]}} USD per
 *   provider for this one row, plus whether any model in it priced at $0
 *   for want of a RATE_TABLE entry
 */
export function priceRowByProvider(row, rateTable = RATE_TABLE, opts = {}) {
  ...
  return { cellKey: priced.cellKey, byProvider, hasMissingRate: missingRateModels.length > 0, missingRateModels };
}
 ...
 * @returns {{byProvider: Object<string, number>, hasMissingRate: boolean, missingRateModels: string[]}}
 */
export function priceRowsByProvider(rows, rateTable = RATE_TABLE, opts = {}) {
  ...
  return { byProvider, hasMissingRate: missingRateModels.size > 0, missingRateModels: [...missingRateModels] };
}
