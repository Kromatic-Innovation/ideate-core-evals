...
// supply its own `candidateCount` -- 30, matching arms.config.json's
// `panel.size x panel.ideasPerAgent` (5 x 6) AND arm A's own
// `totalIdeasRequested: 30` (the file's header comment: every arm is
// "matched on total ideas requested"). This is the RAW idea count before any
// internal digest/dedup the engine may apply -- an over-projection, the safe
// direction, not a validated post-dedup pool size.
